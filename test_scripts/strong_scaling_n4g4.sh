...
#SBATCH -t 01:30:00
#SBATCH --mem=64GB
#SBATCH -o ./logs/strong_scaling_n4g4_%j.out
#SBATCH -e ./logs/strong_scaling_n4g4_%j.err
...
echo "=== 强扩展性测试（固定100K样本）: strong_scaling_n4g4 ==="
...
srun python simple_main.py \
    ...
    --dataset-size 100000 \
    --benchmark-name "strong_scaling_n4g4" \
    --output-dir ./results
...
# 检查结果文件
echo "生成的结果文件:"
ls -la results/strong_scaling_n4g4_* 2>/dev/null || echo "未找到结果文件"
